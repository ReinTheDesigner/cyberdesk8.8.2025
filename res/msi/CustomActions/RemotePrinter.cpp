...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_DRIVER_INF_PATH = L"drivers\\CyberDeskPrinterDriver\\CyberDeskPrinterDriver.inf";
    LPCWCH RD_PRINTER_PORT = L"CyberDesk Printer";
    LPCWCH RD_PRINTER_NAME = L"CyberDesk Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"CyberDesk v4 Printer Driver";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through CyberDesk Printer.
