...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("cyberdesk".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../cyberdesk-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\cyberdesk\flutter\build\windows\runner\Debug\ -o . -e ..\cyberdesk\flutter\build\windows\runner\Debug\cyberdesk.exe
