...
const APP_PREFIX: &str = "cyberdesk";
const APPNAME_RUNTIME_ENV_KEY: &str = "cyberdesk_APPNAME";
#[cfg(windows)]
...
mod windows {
    ...
    pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_cyberdesk.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &Path) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_cyberdesk.exe"])
