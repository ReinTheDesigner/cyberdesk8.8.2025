...
def build_flutter_dmg(version, features):
    ...
    '''
    system2(
        "create-dmg --volname \"CyberDesk Installer\" --window-pos 200 120 --window-size 800 400 --icon-size 100 --app-drop-link 600 185 --icon CyberDesk.app 200 190 --hide-extension CyberDesk.app rustdesk.dmg ./build/macos/Build/Products/Release/CyberDesk.app")
...
def main():
    ...
    if windows:
        ...
        system2('mv target/release/rustdesk.exe target/release/CyberDesk.exe')
        pa = os.environ.get('P')
        if pa:
        ...
        if flutter:
            ...
            if osx:
                system2(
                    'strip target/release/bundle/osx/CyberDesk.app/Contents/MacOS/rustdesk')
                system2(
    ...
    #rcodesign sign --p12-file ~/.p12/rustdesk-developer-id.p12 --p12-password-file ~/.p12/.cert-pass --code-signature-flags runtime ./target/release/bundle/osx/CyberDesk.app/Contents/MacOS/rustdesk
    #rcodesign sign --p12-file ~/.p12/rustdesk-developer-id.p12 --p12-password-file ~/.p12/.cert-pass --code-signature-flags runtime ./target/release/bundle/osx/CyberDesk.app/Contents/MacOS/libsciter.dylib
    #rcodesign sign --p12-file ~/.p12/rustdesk-developer-id.p12 --p12-password-file ~/.p12/.cert-pass --code-signature-flags runtime ./target/release/bundle/osx/CyberDesk.app
