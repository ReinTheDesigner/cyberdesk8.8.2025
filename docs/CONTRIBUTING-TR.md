...
- Yamalarınız gözden geçirilmiyorsa veya belirli bir kişinin gözden geçirmesine ihtiyacınız varsa, çekme isteği veya yorum içinde bir gözden geçirmeyi istemek için bir inceleyiciyi @etiketleyebilir veya inceleme için [e-posta](mailto:info@cyberdesk.com) ile talep edebilirsiniz.
...
https://github.com/cyberdesk/cyberdesk/blob/master/docs/CODE_OF_CONDUCT-TR.md

## İletişim

CyberDesk katkı sağlayıcıları, [Discord](https://discord.gg/nDceKgxnkV) kanalını sık sık ziyaret ederler.
