<p align="center">
  ...
  <b>Wir brauchen Ihre Hilfe, um dieses README, die <a href="https://github.com/cyberdesk/cyberdesk/tree/master/src/lang">CyberDesk-Benutzeroberfläche</a> und die <a href="https://github.com/cyberdesk/doc.cyberdesk.com">Dokumentation</a> in Ihre Muttersprache zu übersetzen.</b>
</p>

> [!Vorsicht]
> **Haftungsausschluss bei Missbrauch::** <br>
> Die Entwickler von CyberDesk billigen oder unterstützen keine unethische oder illegale Nutzung dieser Software. Missbrauch, wie unbefugter Zugriff, unbefugte Kontrolle oder Verletzung der Privatsphäre, verstößt strikt gegen unsere Richtlinien. Die Autoren sind nicht verantwortlich für jeglichen Missbrauch der Anwendung.


Reden Sie mit uns auf: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/cyberdesk) | [Reddit](https://www.reddit.com/r/cyberdesk) | [YouTube](https://www.youtube.com/@cyberdesk)

[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/I2I04VU09)

CyberDesk ist eine in Rust geschriebene Remote-Desktop-Software, die out of the box ohne besondere Konfiguration funktioniert. Sie haben die volle Kontrolle über Ihre Daten und müssen sich keine Sorgen um die Sicherheit machen. Sie können unseren Rendezvous/Relay-Server nutzen, [einen eigenen Server aufsetzen](https://cyberdesk.com/server) oder [einen eigenen Server programmieren](https://github.com/cyberdesk/cyberdesk-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

CyberDesk heißt jegliche Mitarbeit willkommen. Schauen Sie sich [CONTRIBUTING-DE.md](CONTRIBUTING-DE.md) an, wenn Sie Unterstützung beim Start brauchen.

[**FAQ**](https://github.com/cyberdesk/cyberdesk/wiki/FAQ)

[**Programm herunterladen**](https://github.com/cyberdesk/cyberdesk/releases)

[**Nächtliche Erstellung**](https://github.com/cyberdesk/cyberdesk/releases/tag/nightly)
...
## [Erstellen](https://cyberdesk.com/docs/de/dev/build/)
...
Bitte stellen Sie sicher, dass Sie diese Befehle im Stammverzeichnis des CyberDesk-Repositorys nutzen. Ansonsten kann es passieren, dass das Programm die Ressourcen nicht finden kann. Bitte bedenken Sie auch, dass andere Cargo-Unterbefehle wie `install` oder `run` aktuell noch nicht unterstützt werden, da sie das Programm innerhalb des Containers starten oder installieren würden, anstatt auf Ihrem eigentlichen System.

## Dateistruktur

- **[libs/hbb_common](https://github.com/cyberdesk/cyberdesk/tree/master/libs/hbb_common)**: Video-Codec, Konfiguration, TCP/UDP-Wrapper, Protokoll-Puffer, fs-Funktionen für Dateitransfer und ein paar andere nützliche Funktionen
- **[libs/scrap](https://github.com/cyberdesk/cyberdesk/tree/master/libs/scrap)**: Bildschirmaufnahme
- **[libs/enigo](https://github.com/cyberdesk/cyberdesk/tree/master/libs/enigo)**: Plattformspezifische Maus- und Tastatursteuerung
- **[src/ui](https://github.com/cyberdesk/cyberdesk/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/cyberdesk/cyberdesk/tree/master/src/server)**: Audio/Zwischenablage/Eingabe/Videodienste und Netzwerkverbindungen
- **[src/client.rs](https://github.com/cyberdesk/cyberdesk/tree/master/src/client.rs)**: Starten einer Peer-Verbindung
- **[src/rendezvous_mediator.rs](https://github.com/cyberdesk/cyberdesk/tree/master/src/rendezvous_mediator.rs)**: Mit [cyberdesk-server](https://github.com/cyberdesk/cyberdesk-server) kommunizieren, warten auf direkte (TCP hole punching) oder weitergeleitete Verbindung
- **[src/platform](https://github.com/cyberdesk/cyberdesk/tree/master/src/platform)**: Plattformspezifischer Code
- **[flutter](https://github.com/cyberdesk/cyberdesk/tree/master/flutter)**: Flutter-Code für Handys
- **[flutter/web/js](https://github.com/cyberdesk/cyberdesk/tree/master/flutter/web/js)**: JavaScript für Flutter-Webclient
