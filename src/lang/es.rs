...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red CyberDesk en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que CyberDesk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar CyberDesk a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a CyberDesk de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a CyberDesk de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que CyberDesk use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [CyberDesk Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep CyberDesk background service", "Dejar CyberDesk como Servicio en 2do plano"),
        ...
        ("Show CyberDesk", "Mostrar CyberDesk"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a CyberDesk permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a CyberDesk permisos de \"Grabar Audio\"."),
        ...
        ("verify_cyberdesk_password_tip", "Verificar la contraseña de CyberDesk"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses CyberDesk e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_cyberdesk_server_pro_to_{}_tip", "¡Por favor, actualiza CyberDesk Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que CyberDesk no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de CyberDesk"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de CyberDesk de fondo"),
        ...
        ("About CyberDesk", "Acerca de CyberDesk"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_cyberdesk_client_to_{}_tip", "Por favor, actualiza el cliente CyberDesk a la versión {} o superior en el lado remoto"),
