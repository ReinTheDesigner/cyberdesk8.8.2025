...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete CyberDesk..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), CyberDesk diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare CyberDesk a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a CyberDesk su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a CyberDesk su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a CyberDesk de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada CyberDesk]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep CyberDesk background service", "Mantene su servìtziu de CyberDesk in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione CyberDesk, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("Show CyberDesk", "Mustra CyberDesk"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a CyberDesk sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a CyberDesk."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de CyberDesk."),
        ...
        ("verify_cyberdesk_password_tip", "Cunfirma sa crae de CyberDesk"),
        ...
        ("Exit", "Essi dae CyberDesk"),
        ("Open", "Aberi CyberDesk"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare CyberDesk e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_cyberdesk_server_pro_to_{}_tip", "Atualiza CyberDesk Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de CyberDesk comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae CyberDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana CyberDesk est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de CyberDesk"),
        ...
        ("About CyberDesk", "Informatziones subra de CyberDesk"),
        ...
        ("upgrade_remote_cyberdesk_client_to_{}_tip", "Atualiza su cliente CyberDesk remotu a sa versione {} o prus noa!"),
