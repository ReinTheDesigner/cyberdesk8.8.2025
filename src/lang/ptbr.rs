...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do CyberDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o CyberDesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o CyberDesk no sistema."),
        ("Click to upgrade", "Clique para fazer o upgrade"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao CyberDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao CyberDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o CyberDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [CyberDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep CyberDesk background service", "Manter o serviço do CyberDesk executando em segundo plano"),
        ...
        ("Show CyberDesk", "Exibir CyberDesk"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do CyberDesk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do CyberDesk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do CyberDesk."),
        ...
        ("verify_cyberdesk_password_tip", "Verifique a senha do CyberDesk"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o CyberDesk e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_cyberdesk_server_pro_to_{}_tip", "Atualize o CyberDesk Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o CyberDesk funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por CyberDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do CyberDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço CyberDesk em segundo plano"),
        ...
        ("About CyberDesk", "Sobre CyberDesk"),
        ...
        ("upgrade_remote_cyberdesk_client_to_{}_tip", "Atualize o cliente CyberDesk para a versão {} ou superior no lado remoto."),
