...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_rustdesk_password_tip", "Kinnita CyberDeski parool"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda CyberDesk Server Pro versioonile {} või uuem!"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Täiendage CyberDeski klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
