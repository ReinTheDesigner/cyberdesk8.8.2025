...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "CyberDesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować CyberDesk w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić CyberDesk przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić CyberDesk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [CyberDesk Input]."),
        ...
        ("Language", "Język"),
        ("Keep CyberDesk background service", "Zachowaj usługę CyberDesk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji CyberDesk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show CyberDesk", "Pokaż CyberDesk"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji CyberDesk uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z CyberDesk w Twojej sieci."),
        ...
        ("verify_cyberdesk_password_tip", "Weryfikuj hasło CyberDesk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu CyberDesk - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_cyberdesk_server_pro_to_{}_tip", "Proszę zaktualizować CyberDesk Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu CyberDesk po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez CyberDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno CyberDesk jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę CyberDesk w tle"),
        ...
        ("upgrade_remote_cyberdesk_client_to_{}_tip", "Proszę zaktualizować zdalny klient CyberDesk do wersji {} lub nowszej!"),
