...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_rustdesk_password_tip", "CyberDesk 비밀번호 확인"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "CyberDesk Server Pro를 {} 버전 이상으로 업그레이드하세요!"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "CyberDesk 클라이언트를 원격 버전 {} 이상으로 업그레이드해 주세요!"),
