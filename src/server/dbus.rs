...
///
/// Note:
/// On linux, we use dbus to communicate multiple cyberdesk process.
...
const DBUS_NAME: &str = "org.cyberdesk.cyberdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "CyberDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.cyberdesk.cyberdesk /dbus org.cyberdesk.cyberdesk.NewConnection string:'PEER_ID'`
