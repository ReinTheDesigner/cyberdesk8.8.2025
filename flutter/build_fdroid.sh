...
#
# Script to build F-Droid release of CyberDesk
#
# Copyright (C) 2024, The CyberDesk Authors
...
prebuild)
	...
	# Install Flutter version for CyberDesk library build
